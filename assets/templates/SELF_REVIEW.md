...
- `CONTENT_REACHABILITY.json` wheel/touch contracts and reachable item totals:
...
- Ancestor-clipping and content-reachability failures:
- P0 / P1 totals:

## Integrity checks

- No full-page screenshot background:
...
Set `passed` only from the evidence reports. List every unrun independent review or environment limitation plainly.
